...
## [6.0.0](https://github.com/leanlp/EVM-Rust/compare/revm-interpreter-v5.0.0...revm-interpreter-v6.0.0) - 2024-05-16

### Added
- adjust gas-costs for EIP-2935 BLOCKHASH ([#1422](https://github.com/leanlp/EVM-Rust/pull/1422))
- add Opcode::modifies_memory back ([#1421](https://github.com/leanlp/EVM-Rust/pull/1421))
- *(EOF)* Add CALLF/JUMPF stack checks ([#1417](https://github.com/leanlp/EVM-Rust/pull/1417))
- *(EOF)* remove TXCREATE ([#1415](https://github.com/leanlp/EVM-Rust/pull/1415))

### Fixed
- blockchash for devnet-0  ([#1427](https://github.com/leanlp/EVM-Rust/pull/1427))

### Other
- Revert "Revert "feat: implement EIP-2935 ([#1354](https://github.com/leanlp/EVM-Rust/pull/1354))" ([#1424](https://github.com/leanlp/EVM-Rust/pull/1424))" ([#1426](https://github.com/leanlp/EVM-Rust/pull/1426))
- Revert "feat: implement EIP-2935 ([#1354](https://github.com/leanlp/EVM-Rust/pull/1354))" ([#1424](https://github.com/leanlp/EVM-Rust/pull/1424))
- *(EOF)* rename extcall opcode/names ([#1416](https://github.com/leanlp/EVM-Rust/pull/1416))
- point to gas! in Gas::record_cost ([#1413](https://github.com/leanlp/EVM-Rust/pull/1413))
- pop_address should use crate scope ([#1410](https://github.com/leanlp/EVM-Rust/pull/1410))
- Remove Host constrain from calc_call_gas ([#1409](https://github.com/leanlp/EVM-Rust/pull/1409))
